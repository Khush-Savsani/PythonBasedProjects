...
class Airline
{
    String to, from, TO, FROM, Fname, Mname, Lname, seat_no, Mo_no, Duration;
    ...
    String r1 = "AHMEDABAD", r2 = "MUMBAI" , r3 = "DELHI", r4 = "BENGALURU", r5 = "KOLKATA", r6 = "HYDERABAD", r7 = "CHENNAI";
    void book_ticket()
    {
        ...
        while(route)
        {
            ...
            System.out.println("1." + r1 + "  2." + r2 + "  3." + r3 + "  4." + r4 + "  5." + r5 + "  6." + r6 + "  7." + r7);
            System.out.println();
            ...
            while (check_route)
            {
                ...
                if(TO.equals(r1)||TO.equals(r2)||TO.equals(r3)||TO.equals(r4)||TO.equals(r5)||TO.equals(r6)||TO.equals(r7))
                {
                    check_route = false;
                }
                else
            ...
            while (check_route) 
            {
                ...
                if(FROM.equals(r1)||FROM.equals(r2)||FROM.equals(r3)||FROM.equals(r4)||FROM.equals(r5)||FROM.equals(r6)||FROM.equals(r7))
                {
                    check_route = false;
                }
                else
    ...
    void seat_selection()
    {
        ...
        while (seat) 
        {
            ...
            String s3 = s2[1];// After splitting, 1st character stored in s2[0] and number  like 01,02... stored in s[3] and that number will stored in String s3

            if(seat_no.charAt(0)=='A'||seat_no.charAt(0)=='F')
            {
                s3 = s3.replaceFirst("0", "");// remove 0 from 01 or 02 0r 03... and stored in int s3
            }
    ...
    void price_set()
    {
        ...
        System.out.println("\nDo you want to get Travel insurance ?\nIf you get travel insurance, you will cancle the ticket then you will get full refund of your Total price");
        System.out.println("\nFor get Travel insurance, you have to pay 800/- Ruppes");
        ...
        while(insurance_choice)
        {
            ...
            {
                System.out.println("If you will cancle yor ticket, You will get " + total_price +"/- Refund");
            ...
            {   
                ...
                System.out.println("If you will cancle yor ticket, You will get " + (total_price-((35*total_price)/100)) +"/- Refund");
                insurance_choice = false;
            }
            else
            {
                System.out.println("You have entered invalid choice , pllease enter correct choice");
            }
        }
        payment();
    }
            ...
            { 
                case 1:
                    ...
                    while (credit) 
                    {
                        ...
                        {
                            System.out.println("Credit card no. length must be 16 digits only");
                        }    
                    }
                    if(i==16)
                        {
                            System.out.println("You have to pay " + total_price + "/- For book a ticket");
                ...
                case 2: 
                    ...
                    while (debite_check) 
                    {
                        ...
                        System.out.println("Enter your Debite card number");
                        ...
                        if(debite_no.length()==12)
                        {
                            for(int k=0; k<12; k++)
                            {
                                ...
                                {
                                    System.out.println("Please enter correct Debite card no.");
                                    break;
                                }
                            }
                        }
                        ...
                        {
                            System.out.println("Debite card no. length must be 12 digits only");
                        }    
                    }
                        while (debite) 
                        {
                            ...
                            if(n==6 || n==4)
                            {
                                for(i=0; i<n; i++)
                                {
                                    ...
                                    {
                                        System.out.println("Please enter correct Debite card password");
                                        break;
                                    }
                                }
                            }
                            ...
                            {
                                System.out.println("Debite card password length must be 4 or 6 digits only");
                            }    
                        }
                        if(i==n)
                            {
    ...
    void show_ticket()
    {
        ...
        if(ticket_booked && ticket_status==1)
        {
            ...
            System.out.println("Flight no : AB1272");
    ...
    void cancle_ticket()
    {
        ...
        if(ticket_booked && ticket_status==1)
        {
            ...
            System.out.println("\nAre you sure want to cancle a booking?");
            while (cancle_check) 
            {
                System.out.println("Press 1 for Yes\nPress 2 for No"); 
                ...
                switch (cancle_choice)
                {
                    case 1:
                        ...
                        {
                            System.out.println("Okay, you will get " + (total_price-((35*total_price)/100)) + "/- Refund");
                            ++ticket_status;
                            cancle_check = false;
                        }
                        break;
...
class Airplane
{
    public static void main(String args[])
    {
        ...
        while(b)
        {
            System.out.println("\nPress 1 for book a flight ticket");
            System.out.println("Press 2 for show a flight ticket");
            System.out.println("Press 3 for cancle a flight ticket");
